"use strict";
(self["webpackChunkvodka_brand_site"] = self["webpackChunkvodka_brand_site"] || []).push([["src_components_about_js"],{
...
#app #about #located #aside {
  display: flex;
  flex-direction: column;
  align-items: center;
}
#app #about #located #aside #bottles {
  height: 300px;
  width: 500px;
  border: ridge #4a3f35 5px;
}
#app #about #located #aside #map-txt {
  height: 90%;
  width: 90%;
  padding: 20px;
...
#app #about #display .photos {
  width: 40%;
}
#app #about #display #tags {
  margin-top: -30px;
  color: #4a3f35;
  padding: 20px;
  margin-left: -300px;
}
#app #about #display #tags #name {
  font-size: 40px;
  margin-bottom: -20px;
}
#app #about #display #tags p {
  font-family: "Courier New", Courier, monospace;
}
#app #about #display #house {
  border: ridge #4a3f35 5px;
  margin-right: -150px;
  margin-left: 40px;
}`, "",{"version":3,"sources":["webpack://./src/styles/about.scss"],"names":[],"mappings":"AAGA;EACI,sCAAA;EACA,iDAAA;EACA,sEAAA;AAFJ;AAIA;EACI,aAAA;EACA,sBAAA;AAFJ;AAGI;EACI,sCAAA;EACA,kBAAA;EACA,cAAA;AADR;AAGI;EACI,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,kBAAA;AADR;AAEQ;EACI,UAAA;EACA,aAAA;EACA,8CAAA;AAAZ;AAEQ;EACI,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,mBAAA;EACA,kBAAA;AAAZ;AACY;EACI,aAAA;EACA,sBAAA;EACA,mBAAA;AAChB;AAAgB;EACI,aAAA;EACA,YAAA;EACA,yBAAA;AAEpB;AAAgB;EACI,WAAA;EACA,UAAA;EACA,aAAA;EACA,wEAAA;AAEpB;AAEQ;EACI,aAAA;EACA,mBAAA;EACA,uBAAA;AAAZ;AACY;EACI,UAAA;AAChB;AACY;EACI,iBAAA;EACA,cAAA;EACA,aAAA;EACA,mBAAA;AAChB;AAAgB;EACI,eAAA;EACA,oBAAA;AAEpB;AAAgB;EACI,8CAAA;AAEpB;AACY;EACI,yBAAA;EACA,oBAAA;EACA,iBAAA;AAChB","sourcesContent":["$cream: #fff7e6;\n$darkEarth: #4a3f35;\n$accent: #bcaaa4;\n@font-face {\n    font-family: 'Young Style', sans-serif;\n    font-family: 'Young Style Underlines', sans-serif;\n    src: url('https://fonts.cdnfonts.com/css/young-style') format('woff2');\n}\n#app {\n    display: flex;\n    flex-direction: column;\n    #title, #name {\n        font-family: 'Young Style', sans-serif;\n        text-align: center;\n        color: #4a3f35;\n    }\n    #about {\n        display: flex;\n        flex-direction: column;\n        align-items: center;\n        text-align: center;\n        #about-txt {\n            width: 90%;\n            padding: 20px;\n            font-family: 'Courier New', Courier, monospace;\n        }\n        #located {\n            display: flex;\n            flex-direction: row;\n            justify-content: center;\n            align-items: center;\n            margin-left: 100px;\n            #aside {\n                display: flex;\n                flex-direction: column;\n                align-items: center;\n                #bottles {\n                    height: 300px;\n                    width: 500px;\n                    border: ridge #4a3f35 5px;\n                }\n                #map-txt {\n                    height: 90%;\n                    width: 90%;\n                    padding: 20px;\n                    font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;\n                }\n            }\n        }\n        #display {\n            display: flex;\n            flex-direction: row;\n            justify-content: center;\n            .photos {\n                width: 40%;\n            }\n            #tags {\n                margin-top: -30px;\n                color: #4a3f35;\n                padding: 20px;\n                margin-left: -300px;\n                #name{\n                    font-size: 40px;\n                    margin-bottom: -20px;\n                }\n                p{\n                    font-family: 'Courier New', Courier, monospace;\n                }\n            }\n            #house {\n                border: ridge #4a3f35 5px;\n                margin-right: -150px;\n                margin-left: 40px;\n            }\n        }\n    }\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=src_components_about_js7501447d29024e8b30b3.js.map