"use strict";
(self["webpackChunkvodka_brand_site"] = self["webpackChunkvodka_brand_site"] || []).push([["src_components_contact_js"],{
...
var Contact = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var today, submitBtn, messageForm;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          today = new Date().toLocaleDateString('en-US');
          submitBtn = document.getElementById('submit-btn');
          messageForm = document.getElementById('message-us');
          submitBtn.addEventListener('click', /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
              var formData, messageData, response, responseData;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    event.preventDefault(); // Prevent the default form submission behavior
                    formData = new FormData(messageForm); // Gather form data
                    messageData = {
                      date: today,
                    ...
                    _context.prev = 3;
                    _context.next = 6;
                    return fetch('http://localhost:3003/messages/send', {
                      method: 'POST',
                      headers: {
...
form #submit:hover {
  ...
  color: #fff7e6;
}`, "",{"version":3,"sources":["webpack://./src/styles/contact.scss"],"names":[],"mappings":"AAGA;EACI,sCAAA;EACA,iDAAA;EACA,sEAAA;AAFJ;AAIA;EACI,kBAAA;AAFJ;;AAIA;EACI,kBAAA;AADJ;AAEI;EACI,iBAAA;EACA,kBAAA;EACA,MAAA;EACA,0BAAA;AAAR;AAEI;EACI,sCAAA;EACA,gBAAA;EACA,YAAA;EACA,kBAAA;EACA,kBAAA;EACA,0BAAA;AAAR;AAEI;EACI,cA3BI;EA4BJ,sCAAA;EACA,iBAAA;AAAR;AAEI;EACI,cA/BC;AA+BT;;AAGA;EAII,kBAAA;EACA,aAAA;EACA,sBAAA;AAHJ;AAFI;EACI,aAAA;AAIR;AACI;EACI,YAAA;EACA,WAAA;AACR;AACI;EACI,kBAAA;EACA,UAAA;EACA,yBAjDI;EAkDJ,sCAAA;EACA,oBAAA;EACA,eAAA;EACA,cApDC;EAqDD,mBAAA;AACR;AACI;EACI,yBAAA;EACA,cAAA;AACR","sourcesContent":["$cream: #fff7e6;\n$darkEarth: #4a3f35;\n$accent: #bcaaa4;\n@font-face {\n    font-family: 'Young Style', sans-serif;\n    font-family: 'Young Style Underlines', sans-serif;\n    src: url('https://fonts.cdnfonts.com/css/young-style') format('woff2');\n}\n#app{\n    overflow-x: hidden;\n}\n#header {\n    text-align: center;\n    #banner {\n        min-width: 1000px;\n        position: relative;\n        top: 0;\n        border: outset #4a3f35 4px;\n    }\n    #title {\n        font-family: 'Young Style', sans-serif;\n        font-size: 100px;\n        color: white;\n        margin-top: -200px;\n        position: relative;\n        text-shadow: black 2px 2px;\n    }\n    h2 {\n        color: $darkEarth;\n        font-family: 'Young Style', sans-serif;\n        margin-top: -50px;\n    }\n    #our-email {\n        color: $accent;\n    }\n}\nform {\n    label{\n        display: none;\n    }\n    text-align: center;\n    display: flex;\n    flex-direction: column;\n    *{\n        padding: 8px;\n        margin: 5px;\n    }\n    #submit{\n        align-self: center;\n        width: 20%;\n        background-color: $darkEarth;\n        font-family: 'Young Style', sans-serif;\n        border-radius: 0.5em;\n        font-size: 20px;\n        color: $accent;\n        border: #4a3f35 2px;\n    }\n    #submit:hover{\n        background-color: #bcaaa4;\n        color: #fff7e6;\n    }\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=src_components_contact_js8e39def7fc057a909921.js.map